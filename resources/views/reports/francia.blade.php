...
<div class="container">
  <div class="row">
    <div class="panel panel-default">
      <div class="panel-heading">Reportes Francia</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          <form action="errors" method="post" class="dropzone">
            <input type="hidden" name="francias_id" v-model="id_for_report">
          </form>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/francia/update" method="post" class="generalForm" v-on:submit="validate($event)">
          <!-- Fecha de fallo -->
...
<div class="modal fade generalForm" id="create-form" tabindex="-1" role="dialog" aria-labelledby="create-form">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/francia/create" method="post" class="generalForm" v-on:submit="validate($event)">
          <!-- Fecha de fallo -->
          <div class="form-group">
            <label for="date">Fecha y hora</label>
...
@endsection
@section('scripts')
<script src="/js/francia/app.js"></script>
@endsection
<script>
