...
<div class="container">
  <div class="row">
    <div class="panel panel-default">
      <div class="panel-heading">Reportes Vicalvaro</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          <form action="errors" method="post" class="dropzone">
            <input type="hidden" name="vicalvaros_id" v-model="id_for_report">
          </form>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/vicalvaro/update" method="post" class="generalForm" v-on:submit="validate($event)">
          <!-- Fecha de fallo -->
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="host" placeholder="Maquina" name="host" v-model="host" >
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="new_session" placeholder="Sesión nueva" name="new_session" v-model="new_session" >
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="incident" placeholder="Incidencia" name="incident" v-model="incident" >
          </div>
          <!-- Enlace -->
          <div class="form-group">
...
<div class="modal fade generalForm" id="create-form" tabindex="-1" role="dialog" aria-labelledby="create-form">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/vicalvaro/create" method="post" class="generalForm" v-on:submit="validate($event)">
          <!-- Fecha de fallo -->
          <div class="form-group">
            <label for="date">Fecha y hora</label>
...
@endsection
@section('scripts')
<script src="/js/vicalvaro/app.js"></script>
@endsection
<script>
